...
JPN_earthquake <- earthquake[str_detect(JPN_earthquake$place, "Japan", negate = FALSE), ]
...
tm_shape(JPN) + tm_borders() + tm_shape(nuclear_point) + tm_dots(col = "red") + tm_shape(JPN_earthquake) + tm_dots() + tm_scale_bar()
```
